...
class IncomeDetails extends StatefulWidget {
  ...
  const IncomeDetails(
      {Key? key, required this.service, this.incomes, required this.type})
      : super(key: key);
...
class _IncomeDetailsState extends State<IncomeDetails> {
  ...
  void initState() {
    super.initState();
    _textController = TextEditingController(text: widget.incomes?.title);
    _amountController =
        TextEditingController(text: widget.incomes?.amount.toString());
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (widget.type == "update")
                          GestureDetector(
                              onTap: () {
                                widget.service.deleteIncome(widget.incomes!.id);
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return "Income Name is not allowed to be empty";
                            }
                            return null;
                          },
                        ),
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return "Income Amount is not allowed to be empty";
                            }
                            return null;
                          },
                        ),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          if (widget.type == 'update') {
                            widget.service.saveIncomes(Incomes()
                              ..id = widget.incomes!.id
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                "New Income '${_textController.text}' successful modified!",
                              ),
                            ),
                          );
