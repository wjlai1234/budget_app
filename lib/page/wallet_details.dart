...
class WalletDetails extends StatefulWidget {
  ...
  const WalletDetails(
      {Key? key, required this.service, this.account, required this.type})
      : super(key: key);
...
class _WalletDetailsState extends State<WalletDetails> {
  ...
  void initState() {
    super.initState();
    _textController = TextEditingController(text: widget.account?.title);
    _amountController =
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (widget.type == "update")
                          GestureDetector(
                              onTap: () {
                                widget.service.deleteAcc(widget.account!.id);
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return "Account Amount is not allowed to be empty";
                            }
                            return null;
                          },
                        ),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            if (widget.type == 'update') {
                              widget.service.saveAccount(Account()
